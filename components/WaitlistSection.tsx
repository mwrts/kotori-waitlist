...
const BirdIcon = ({ color, size = 32 }: { color: string; size?: number }) => (
  <svg width={size} height={size} viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
    {/* Feet */}
    <path d="M48 102C48 106 46 108 42 108M48 102C48 106 51 108 54 108" stroke="#3D3D3D" strokeWidth="1.8" strokeLinecap="round" />
    <path d="M72 102C72 106 70 108 66 108M72 102C72 106 75 108 78 108" stroke="#3D3D3D" strokeWidth="1.8" strokeLinecap="round" />
    
    {/* Wings */}
    <path d="M26 68C18 68 18 82 26 82" stroke="#3D3D3D" strokeWidth="2.5" strokeLinecap="round"/>
    <path d="M94 68C102 68 102 82 94 82" stroke="#3D3D3D" strokeWidth="2.5" strokeLinecap="round"/>
    
    {/* Main Body */}
    <circle cx="60" cy="72" r="40" fill={color} stroke="#3D3D3D" strokeWidth="2.5" />
    
    {/* Tummy highlight */}
    <circle cx="60" cy="84" r="26" fill="white" fillOpacity="0.25" />
    ...
    {/* Eyes */}
    <g>
      <circle cx="44" cy="62" r="10" fill="white" stroke="#3D3D3D" strokeWidth="2" />
      <circle cx="44" cy="62" r="5" fill="#3D3D3D" />
      <circle cx="46" cy="60" r="1.8" fill="white" />
      
      <circle cx="76" cy="62" r="10" fill="white" stroke="#3D3D3D" strokeWidth="2" />
      <circle cx="76" cy="62" r="5" fill="#3D3D3D" />
      <circle cx="78" cy="60" r="1.8" fill="white" />
    </g>
    
    {/* Beak */}
    <path d="M54 74C54 70 66 70 66 74C66 81 60 85 60 85C60 85 54 81 54 74Z" fill="#FFA726" stroke="#3D3D3D" strokeWidth="2" strokeLinejoin="round" />
  </svg>
);
